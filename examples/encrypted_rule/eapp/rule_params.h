...
#define _H_RULE_PARAMS_H_
    ...
    #define RULE_ACTION_PARAMS_UNESCAPED { "{ \"attrib1\" : \"val1\", \"attrib2\" : \"val2\", \"action_url\": \"http://node0.spigot.cs799-serverless-pg0.wisc.cloudlab.us:80/action_data/\", \"action_id\": \"0\" }",}
#endif
