...
extern int format_action_data(char **action_data_json, int num_actions, char **ingredients, int num_ingredients);
extern int *get_action_skip_vector();
//Includes the action params and the nonce in the returned data
extern char *get_action_data(int i, int32_t *size, char *action_params, int32_t action_param_sz);
