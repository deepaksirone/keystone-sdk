...
#define KEYSTONE_IOC_GET_VERIFIABLE_NONCE \
  _IOR(KEYSTONE_IOC_MAGIC, 0x08, struct keystone_ioctl_get_verifiable_nonce)
...
struct keystone_ioctl_get_verifiable_nonce {
  uintptr_t error;
  uintptr_t value;
};
